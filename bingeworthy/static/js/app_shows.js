...
function filterData(dd) {
    ...
    for(i=0;i<tableData.length;i++){
        ...
        // if(String(tableData[i].datetime)==String(dd) && states.includes(tableData[i].state) && cities.includes(tableData[i].city) && show_type.includes(tableData[i].shape) && titles.includes(tableData[i].title)){
        if(dates_2.includes(tableData[i].datetime) && states.includes(tableData[i].state) && cities.includes(tableData[i].city) && show_type.includes(tableData[i].shape) && titles.includes(tableData[i].title)){
...
for(i=0;i<cities.length;i++){
    spanLi.append("input").attr("checked", true).attr("show_type", "checkbox").attr("id", "cities"+i).attr("name", "cities").attr("value", cities[i]);
